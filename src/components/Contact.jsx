  ...
  return (
    <div className={`xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden`}>
      ...
      >
        ...
        <div className='flex gap-5 mt-3 mb-2 flex-wrap'>
          <a
            href="https://linkedin.com/in/netramanipokhrel"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#915EFF] hover:text-white flex items-center gap-1.5 font-medium transition-colors duration-300"
          >
          ...
          <a
            href="https://github.com/Netrahoni"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#915EFF] hover:text-white flex items-center gap-1.5 font-medium transition-colors duration-300"
          >
