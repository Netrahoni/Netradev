  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.2, 0.75)}>
      <Tilt
        ...
        className='bg-tertiary p-6 rounded-2xl sm:w-[360px] w-full min-h-[350px] flex flex-col justify-between border border-[#915EFF]/10 hover:border-[#915EFF]/30 transition-all duration-300 shadow-card hover:shadow-2xl cursor-pointer group'
